...
### 字段
- 尽量使用**TINYINT、SMALLINT、MEDIUM_INT**作为整数类型而非INT，如果非负则加上**UNSIGNED**
...
比如原始的用户表是：
![DB-MySQL-MySQL大表优化方案-2020322](http://blog-img.csliao.top/ource/_posts/DB-MySQL-MySQL大表优化方案-2020322.png)

垂直拆分后是：
![DB-MySQL-MySQL大表优化方案-20200322203249](http://blog-img.csliao.top/ource/_posts/DB-MySQL-MySQL大表优化方案-20200322203249.png)
...
![DB-MySQL-MySQL大表优化方案-20200322203412](http://blog-img.csliao.top/ource/_posts/DB-MySQL-MySQL大表优化方案-20200322203412.png)

实际情况中往往会是垂直拆分和水平拆分的结合，即将**Users_A_M**和**Users_N_Z**再拆成Users和UserExtras，这样一共四张表
...
这是一个客户端架构的例子：
![DB-MySQL-MySQL大表优化方案-20200322203512](http://blog-img.csliao.top/ource/_posts/DB-MySQL-MySQL大表优化方案-20200322203512.png)
...
这是一个代理架构的例子：
![DB-MySQL-MySQL大表优化方案-20200322203557](http://blog-img.csliao.top/ource/_posts/DB-MySQL-MySQL大表优化方案-20200322203557.png)
...
转自：https://segmentfault.com/a/1190000006158186#item-3
